...
csv_files = [
    r"C:\bovdb\volume\volume_shares\combined_20240628_adjusted.csv",
]
...
# Ler todos os arquivos CSV e concatenar em um único DataFrame
df_list = [read_and_process_csv(file) for file in csv_files]
